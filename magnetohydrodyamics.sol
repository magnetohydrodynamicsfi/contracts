...
contract MagnetoHydroDynamics is IERC20, Ownable {
    ...
    string constant _name = "MagnetoHydroDynamics";
    string constant _symbol = "MHD";
    ...
    address payable public marketingFeeReceiver = payable(0xC9F80CcC2346e98950310F25d2F7697C5b253dc7);
    ...
    function JoinMPool() external {
        swapDistributor(0);
    }
    function JoinHPool() external {
        swapDistributor(1);
    }
    function JoinDPool() external {
        swapDistributor(2);
    }
